...
Docker Minecraft PaperMC server for 1.21, 1.20, 1.19, 1.18, 1.17 for AMD64 and ARM64 platforms. Works on Synology, Raspberry Pi or any other systems that support docker.
